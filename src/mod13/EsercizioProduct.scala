...
//Scrivete le funzioni square, cube e factorial utilizzando la funzione product.

//Scrivete una funzione gen che consenta di generalizzare sia sum sia product
